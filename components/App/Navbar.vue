...
const AppThemeToggle = hydrate(
    () => import("~/components/App/ThemeToggle.vue")
);
const AppNavigationSliderOver = hydrate(
    () => import("~/components/App/NavigationSliderOver.vue")
);
const AppLanguageSelect = hydrate(
    () => import("~/components/App/LanguageSelect.vue")
);
